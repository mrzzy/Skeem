 ...
 * @see ArrayAdapter
 */
public class ScheduleArrayAdapter extends ArrayAdapter<Schedulable> {

    // Basic constructor, call super
    public ScheduleArrayAdapter(Activity context, List<Schedulable> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (schedulable instanceof Task) {
            ...
            if (task.getScheduledStart().getDay() == current_day) {
                task_start_time = task_start_time.substring(9, 14);
            }
